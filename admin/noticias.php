...
<div id="conteudo">
	Windows 8 e seus rumores

Depois do Windows 7, o Windows 8 já traz seus rumores. Ultimamente a Microsoft está colocando diversos serviços de integração, como o Windows Live Messenger 2010 que já integra Facebook e MySpace como padrão, e outros diversos serviços. Entre seus principais rumores estão:


CircleDock: já era rumor do Seven, mas não foi aderido, mas no Windows 8 deve contar com muitas funcionalidades a mais, como por ex. o icone do centro pode se transformar em um player, ou uma tela para acompanhar o Windows. E é claro ainda contando com os atalhos ao seu redor.


Logon: será aprimorado, além do teclado virtual para Tablets, também deve contar com reconhecimento facial, e aprimoramento da leitura biométrica (digitais).
<hr />    
